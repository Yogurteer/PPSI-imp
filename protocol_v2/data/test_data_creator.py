...
# example usage:
# python protocol_v2/data/test_data_creator.py 1000 800 200 32 8
...
dataset_file_name = os.path.join(script_dir, f"dataset_{sender_sz}_{recv_sz}_{int_sz}_{label_bc}_{item_bc}.csv")
