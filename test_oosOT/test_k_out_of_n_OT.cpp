...
int wty_oos_OT_test() {
    std::cout << "╔══════════════════════════════════════════════════════╗\n";
    std::cout << "║     K-out-of-N OT Extension 正确性测试 (重复20次)    ║\n";
    std::cout << "╚══════════════════════════════════════════════════════╝\n";
    
    KOutOfNConfig config;
    config.N = 1 << 10;              // Sender有100个数据
    config.K = 1 << 8;               // Receiver请求10个数据
